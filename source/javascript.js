...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const modalContents = {
        ...
        <h2>Which skin concern is my priority?</h2>
            ...
            <p>If your facial skin is rough, flaky, or thirsty, then we can help rehydrate, rebuild barrier function and prevent dry skin from taking over.</p>
            <h3>Spot-Prone</h3>
            ...
            <h3>Maturing</h3>
            <p>If you're noticing fine lines or deeper wrinkles, then we can help reduce their appearance and prevent new ones from forming with targeted treatments.</p>
            <h3>Rosacea/Sensitive</h3>
            <p>A long-term skin condition where you have redness across your face that may feel hot or painful. Our treatments can help with these symptoms and provide comfort.</p>
        ...
        <h2>What do these severity levels mean?</h2>
            ...
            <p>
                <ul>
                <li>Occasional blackheads and whiteheads.</li>
                <li>A few small spots appearing mostly on the face.</li>
                <li>Minimal inflammation or discomfort.</li>
                </ul>
            </p>
            <h3>Grade 2: Moderate 🟡</h3>
            <p>
                <ul>
                <li>More inflamed spots are present.</li>
                <li>Breakouts include papules and pustules, mainly on the face and possibly extending to the neck.</li>
                <li>Skin may feel more sensitive.</li>
                </ul>
            </p>
            <h3>Grade 3: Severe 🟠</h3>
            <p>
                <ul>
                <li>Numerous red and inflamed spots.</li>
                <li>Often painful to touch</li>
                <li>Breakouts may cover larger areas, including the back and chest.</li>
                </ul>
            </p>
        `,
        acneType:
    ...
    const productBlurbs = {
        ...
        "SPF 50 Sunscreen - Prime & Protect": {
        blurb:
    ...
    filterProducts = function (questionType, selection) {
        ...
        productPoolStack = [initialProductPool.slice()];
        } else {
    ...
    function navigateToNextQuestion(questionType, selection) {
        ...
        case "typeOfAcne":
            if (selection === "cystic") {
            goToExitPoint(
                "Cystic acne often requires targeted care. We strongly recommend booking a consultation so we can provide you with professional, personalised advice and support your skin's recovery journey."
            );
        ...
        case "severityOfAcne":
            if (selection === "severe") {
            goToExitPoint(
                "For severe acne concerns, it's important to take a tailored approach. Please book a consultation so we can assess your skin and recommend prescription-only treatments that suit your needs."
            );
            nextQuestionId = "exitPoint";
            break;
            } else {
        ...
        case "takePrescription":
            if (selection === "yes") {
            goToExitPoint(
                "We advise against using products with active ingredients while you're on prescribed topical medication. Please reach out for a personalised consultation and we’ll guide you on the best time and approach to restart your skincare routine."
            );
            nextQuestionId = "exitPoint";
            break;
            } else {
    ...
    function suggestProduct() {
        ...
        setTimeout(() => {
            ...
            if (poolLength > 1) {
                ...
                document.getElementById("essentialsContainer").style.display = "block";
            ...
            //basics section
            basicPoolLength = basicPool.length;

            basic1 = basicPool[0];
            basic2 = basicPool[1];

            if (basicPoolLength > 0) {
                document.getElementById("basicSection").style.display = "block";
                document.getElementById("basic1").innerHTML = 
                document.getElementById("basic1").innerHTML +
                `
                <h3>${basic1}</h3>
                <p>${productBlurbs[basic1]?.blurb || "No description"}</p>
                <p>${productBlurbs[basic1]?.directions || "No directions"}</p>
                `;
                document.getElementById("basic1ProductImage").src = productBlurbs[basic1]?.imgURL;
                document.getElementById("basic1ProductLink").href = productBlurbs[basic1]?.prodURL || "https://www.francesturnertraill.co.uk/";

                if (basicPoolLength > 1) {
                document.getElementById("basic2").innerHTML = 
                document.getElementById("basic2").innerHTML +
                `
                    <h3>${basic2}</h3>
                    <p>${productBlurbs[basic2]?.blurb || "No description"}</p>
                    <p>${productBlurbs[basic2]?.directions || "No directions"}</p>
                `;
                document.getElementById("basic2ProductImage").src = productBlurbs[basic2]?.imgURL;
                document.getElementById("basic2ProductLink").href = productBlurbs[basic2]?.prodURL || "https://www.francesturnertraill.co.uk/";
                } else {
                document.getElementById("basic2").remove();
                }
                
            } else {
                document.getElementById("basicSection").remove();
            }

            if (poolLength < 3) {
                document.getElementById("advanced3").remove();
            }
